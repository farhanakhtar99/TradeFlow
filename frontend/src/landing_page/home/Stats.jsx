            ...
            <div className="row">
                <div className="col-6 p-5">
                    ...
                    <p className="text-muted">No gimmicks spam, "gamification", or annoying push <br />
                        notifictions. High quality apps that you use at your space the <br />
                        way you like.
                    </p>
                    <h2 className="fs-4">The Zerodha universe</h2>
                    <p className="text-muted">Not just app, but a whole ecosystem. Our investments in <br />
                ...
                <div className="col-6 p-5">
                    <img src="media\images\ecosystem.png" alt="Ecosystem Image" style={{width: "90%"}}/> <br />
                    <div className="text-center">
                        <a href="#" style={{textDecoration: "none"}}>Explore our products <i class="fa-solid fa-arrow-right-long"></i></a>
                        <a href="#" style={{textDecoration: "none"}} className="offset-2">Try Kite Demo <i class="fa-solid fa-arrow-right-long"></i></a>
                    </div>
                </div>
            </div>
        </div>
